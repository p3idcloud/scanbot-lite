'use strict';
const { mergePdfDocument, sendPdfDocument, getFileFromURI } = require('../controllers/storage.controller');
 ...
 */
router.post('/mergepdf', mergePdfDocument);
 ...
 *        description: Error occured
 */
router.post('/sendpdf', sendPdfDocument);
